/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, d as renderComponent, e as renderHead, f as renderSlot } from '../astro.258d6d1c.mjs';
import 'html-escaper';
...
`;
}, "C:/Users/pajap/Desktop/stone/klimtop2_jarda/node_modules/astro/components/ViewTransitions.astro", void 0);
  ...
  const bottomLinks = [
    ...
    */
    ...
    /*
    {
      ...
      links: [
        {
          name: 'Tato webová stránka neukládá marketingové soubory cookie.',
          href: '#',
  ...
  <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
    <div class="flex flex-col justify-between gap-12 sm:gap-16 lg:flex-row">
      <div class="flex max-w-sm flex-col items-start gap-6 sm:gap-8">
        <div class="flex">
            <span class="sr-only">Klim–Tech</span>
            <img class="h-42 w-40" width="160" height="180" src="../../public/assets/klimtop_logo.png" alt="logo klim–top">
          
        </div>
        <p class="text-primary-950/70 dark:text-primary-200/70 text-base">
          Klimatizace & Tepelná čerpadla Jirout
          info@klimtop.cz
        </p>
        
        <p class="text-primary-950/70 dark:text-primary-200/70 text-sm">© 2024 PP511</p>
      </div>
      
      <!-- Bottom links -->
      <div class="grid max-w-xl flex-1 grid-cols-1 gap-8 sm:grid-cols-1 text-center">
...
<div class="bg-primary-600 p-5">
  <p class="text-center text-white font-sm">Tato webová stránka neukládá marketingové soubory cookie.</p>
</div>`;
}, "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/layout/Footer.astro", void 0);
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="mx-auto flex max-w-2xl items-center justify-between px-4 py-4 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
    ...
    <div class="flex">
      <a href="/" class="focus-visible:outline-primary-950 dark:group-focus-visible:outline-primary-200 rounded-md focus-visible:outline focus-visible:outline-2">
        <span class="sr-only">Klim–Tech</span>
        <img class="h-8 w-auto" width="65" height="40" src="/assets/klimtop_logo.png" alt="logo klim–tech">
      </a>
    </div>
    ...
    <div class="-mr-2 flex items-center space-x-2 sm:space-x-3">
      <!-- Toggle theme mode -->
      <button type="button" class="text-primary-950 dark:text-primary-200 hover:bg-primary-500/10 dark:hover:bg-primary-400/10 ring-primary-950 inline-flex h-14 w-14 items-center justify-center rounded-full transition focus:outline-none focus-visible:ring-2" x-data @click="$store.theme.toggle()">
        <span class="sr-only">Přepínání režimu motivu</span>
      ...
      <button type="button" class="text-primary-950 dark:text-primary-200 hover:bg-primary-500/10 dark:hover:bg-primary-400/10 ring-primary-950 inline-flex h-14 w-14 items-center justify-center rounded-full transition focus:outline-none focus-visible:ring-2" @click="open = !open" @mousedown="if (open) $event.preventDefault()" aria-controls="website-menu" aria-expanded="false" :aria-expanded="open.toString()">
        <span class="sr-only">Přepínání menu</span>
  ...
  <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8" id="website-menu" x-cloak x-show="open" x-collapse x-collapse.duration.500ms>
    <div class="grid grid-cols-1 gap-16 pb-24 pt-6 lg:grid-cols-2 lg:pt-12">
      <div class="bg-primary-500/10 dark:bg-primary-400/10 hidden items-center justify-center rounded-3xl px-6 py-8 lg:flex">
        <p class="text-primary-950/70 dark:text-primary-200/70 max-w-sm text-xl italic leading-loose">
          <span class="font-medium">Klimatizace & Tepelná čerpadla Jirout</span> 
          info@klimtop.cz
        </p>
      </div>
      ...
      <nav class="divide-primary-900/10 dark:divide-primary-300/10 flex flex-col gap-1 divide-y">
        ${links.map((link) => renderTemplate`<a${addAttribute(link.href, "href")} class="text-primary-950 dark:text-primary-200 group inline-flex py-6 text-3xl font-medium tracking-tight transition focus-visible:outline-none sm:py-8 sm:text-4xl">
              <div class="group-focus-visible:outline-primary-950 dark:group-focus-visible:outline-primary-200 flex flex-1 items-center justify-between rounded-3xl group-focus-visible:outline group-focus-visible:outline-2 group-focus-visible:outline-offset-2">
                ...
                <svg class="text-primary-600 dark:text-primary-400 h-6 w-6 sm:h-8 sm:w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
}, "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/layout/Header.astro", void 0);
...
}, "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/layouts/Layout.astro", void 0);

const $$Astro = createAstro();
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$404;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "description": "404-Klimatizace&Tepeln\xE1 \u010Derpadla Jirout", "title": "404 error" }, { "default": ($$result2) => renderTemplate`
...
` })}`;
}, "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/pages/404.astro", void 0);

const $$file = "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/pages/404.astro";
const $$url = "/404";
