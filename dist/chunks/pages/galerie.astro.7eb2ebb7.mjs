...
const $$Galerie = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result2, "ImageGallery", App, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/gallery/Galerie1.jsx", "client:component-export": "default" })}
  ${renderComponent($$result2, "ImageGallery2", App2, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/gallery/Galerie2.jsx", "client:component-export": "default" })}
  ${renderComponent($$result2, "ImageGallery3", App3, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/gallery/Galerie3.jsx", "client:component-export": "default" })}
  ${renderComponent($$result2, "ImageGallery4", App4, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/gallery/Galerie4.jsx", "client:component-export": "default" })}
  ${renderComponent($$result2, "ImageGallery5", App5, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/pajap/Desktop/stone/klimtop2_jarda/src/components/gallery/Galerie5.jsx", "client:component-export": "default" })}
` })}`;
